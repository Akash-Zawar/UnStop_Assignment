      ...
      <div className="min-h-screen sm:w-36 bg-white sm:py-6 text-navy-blue">
        <div className="flex flex-col sm:gap-4 items-center w-full">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-xs font-medium text-cyan-900">Dashboard</p>
          </div>
          <div className="flex flex-col items-center sm:gap-2 sm:p-2 bg-blue-100 border-text-blue border-2 rounded-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24"
              viewBox="0 -960 960 960"
            ...
            <p className="text-xs text-text-blue font-medium">Assessment</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="border-b-2 border-grey border-dashed pb-8 w-full ">
              <p className="text-xs font-medium text-cyan-900">My Library</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col items-center justify-center gap-2 sm:py-4">
                ...
                <div>
                  <p className="text-xs text-center font-medium text-cyan-900">
                    Round
                  </p>
                  <p className="text-xs text-center font-medium text-cyan-900">
                    Status
